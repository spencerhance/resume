...
% edX
\item[] {\cventry{May 2018 -- Present}{Software Engineering Intern}
{edX}{Cambridge, MA}{}{\vspace{1pt}}
\vspace{-9pt}	\begin{itemize}
	 \item Developing full-stack microservices for the edX open-source learning platform \textbf{(Python, Django, React)}
	\end{itemize}
}
\vspace{4pt}

% MIT LL
\item[] {\cventry{October 2017 -- May 2018}{Technical Assistant - Machine Learning}
{MIT Lincoln Laboratory}{Cambridge, MA}{}{\vspace{1pt}}
\vspace{-9pt}	\begin{itemize}
	 \item Implemented and documented graph-based machine learning pipeline \textbf{(Python, Anaconda, SLURM)}
...
% AMD round 2
\item[] {\cventry{January -- April 2018}{Research Engineer Co-op - CPU Architecture}
...
% AMD
\item[] {\cventry{January -- July 2017}{Design Engineer Co-op - GPU Architecture}
{Advanced Micro Devices (AMD)}{Boxborough, MA}{}{\vspace{1pt}}
\vspace{-9pt}	\begin{itemize}
...
\vspace{-9pt}	\begin{itemize}
	 ...
	 \item Wrote a \textbf{MEAN.js/JavaScript} application to generate and load test data from Hadoop cluster
...
% SC
\item[] {\cventry{July 2015 -- November 2017}{Application Lead}
...
\vspace{-9pt}	\begin{itemize}
		...
		\item Won the ``MacGyver Award'' for building an HPC cluster from components on the show floor
...
\begin{itemize}
\item[]  \textbf{Languages:} Python, C(++), Bash
\vspace{3pt}
