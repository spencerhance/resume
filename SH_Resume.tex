...
\extrainfo{Availability: January-August 2017}
% optional, remove / comment the line if not wanted
...
% EnerNOC
\item[] {\cventry{January 2016 -- Present}{Performance Engineering Co-op}
...
% ResNet
\item[] {\cventry{October 2014 -- Present}{Computer Technician}
