...
% AMD round 2
\item[] {\cventry{January 2018 -- Present}{CPU Architecture Research Co-op}
{Advanced Micro Devices (AMD)}{Boxborough, MA}{}{\vspace{1pt}}
\vspace{-8pt}	\begin{itemize}
	 \item Researching new CPU cache prefetching methods for Exascale workloads
	\end{itemize}
}
\vspace{6pt}
...
\vspace{-8pt}	\begin{itemize}
	 \item Developing Machine Learning pipelines for varied datasets (\textbf{Python})
